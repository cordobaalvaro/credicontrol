...
router.get("/:id/overview", auth("admin"), obtenerZonaOverview);
router.get("/:id/clientes", auth("admin"), obtenerClientesZona);
router.get("/:id/prestamos", auth("admin"), obtenerPrestamosZona);
